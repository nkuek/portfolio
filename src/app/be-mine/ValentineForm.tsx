    ...
    >
      ...
      <div className="flex gap-4">
        <button
          ...
          style={yesStyle}
          className="bg-primary text-text-on-button hover:bg-primary-hover outline-accent cursor-pointer rounded-xl px-8 py-3 text-lg font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-4"
        >
          Yes! 💕
        </button>
