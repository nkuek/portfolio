...
export default function ProjectSectionClient({
  ...
  return (
    ...
    >
      ...
      />
      <div className="bg-background-dark/95 text-text-dark md:group-data-rvisible=true]:translate-y-0 px-4 pt-12 pb-16 group-odd:group-data-[visible=false]:translate-x-[-15%] after:opacity-0 md:h-[100dvh] md:w-[max(35%,400px)] md:max-w-[660px] md:px-8 md:py-20 md:transition-[opacity,translate] md:duration-750 md:group-data-[visible=false]:opacity-0 md:group-even:group-data-[visible=false]:translate-x-[15%] lg:px-12 lg:py-[120px]">
