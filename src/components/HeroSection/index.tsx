  ...
  return (
    ...
    >
      <div className="relative z-1 flex w-full max-w-[900px] flex-col gap-0 px-16 max-md:items-center">
        <div
          className="bg-border-hairline mb-10 h-px w-full origin-left animate-[drawHairline_1000ms_cubic-bezier(0.0,0.0,0.2,1)_0ms_both]"
          aria-hidden="true"
        />
        ...
        <div
          className="bg-border-hairline mt-10 mb-8 h-px w-full origin-left animate-[drawHairline_1000ms_cubic-bezier(0.0,0.0,0.2,1)_500ms_both]"
          aria-hidden="true"
        />
        ...
        <div
          className="bg-border-hairline mt-10 mb-6 h-px w-full origin-left animate-[drawHairline_1200ms_cubic-bezier(0.0,0.0,0.2,1)_1300ms_both]"
          aria-hidden="true"
        />
